...
6. __∆format__ / __∆f__: An APL-specific implementation of format-strings, reminiscent of Python's __f-strings__, but supporting APL multidimensional objects directly and formatting based on __⎕FMT__. Supports nice constructions like ``∆f 'Employee name: {name}, address: {address}, salary: {P<£>F7.2$⍪salary}'`` interpolating arrays __name__, __address__, and __salary__.
