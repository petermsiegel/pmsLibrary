...
2. __∆MY__: From the namespace __∆MYgrp__, __∆MY__ refers to a private namespace for the current calling function (determined from its actual APL name and the namespace in which it resides). It allows for *static* variables, i.e. ones that persist between executions, e.g. __∆MY.count+←1__ 
and for *initialization*, e.g. 
__:IF ∆MY.∆FIRST ⋄ ∆MY.count←0 ⋄ :ENDIF__.
