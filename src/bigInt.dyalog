...
⍝ --------------------------------------------------------------------------------------------------
  ...
  ⍝ bi:  Returns ⎕THIS
   ...
   ⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯⍝
    ∇ {r}←_LoadPats;actArgScalQ;actArgVecQ;actBiCallNoQ;actBiCallQ;actKeep;lD;lM;pAplInt;pBI;pCom;pFunsBig;pFunsNoQ;pFunsQ;pFunsSmall;pNonBiCode;pQot;pVar;p2Fancy;p2Funs1;p2Funs2;p2Ints;p2Plain;p2Vars;tDM;tD1;tMM;tM1;t1;t2
   ...
   ⍝    pFunsBig must precede pVar, so that MUL10 and SQRT will be treated as BI operands…
      pBiCalls←pCom pFunsQ pVar pQot pFunsNoQ pAplInt pNonBiCode pBI
