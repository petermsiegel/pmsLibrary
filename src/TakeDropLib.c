  ...
  #include <stdio.h>
     ...
     int TakeDrop32(int offset, int32_t *outRaw, int32_t *inRaw,
 ...
 /*  MAGIC OFFSET: Don't use this unless you know what you are doing! */
   ...
   for (r=0; r<tRows; ++r, inPtr+= skip ){
    ...
    return 0;
     ...
     int TakeDrop16(int offset, int16_t *outRaw, int16_t *inRaw,
                    int inRows, int inCols, int tRows, int tCols, int dRows, int dCols){
     int     skip, r, c;
 ...
 /*  MAGIC OFFSET: Don't use this unless you know what you are doing! */
   ...
   for (r=0; r<tRows; ++r, inPtr+= skip ){
    ...
    return 0;
     ...
     int TakeDrop8(int offset, int8_t *outRaw, int8_t *inRaw,
                    int inRows, int inCols, int tRows, int tCols, int dRows, int dCols){
     int     skip, r, c;
